...
button.addEventListener ("click", function() {
    ...
    for (var i = 0; i < attacks.length; i++) {
      ...
      attackerPosX = attacks[i].getElementsByClassName("coordinateX")[0].innerHTML.replace(/[^\d.-]/g, '');
      attackerPosY = attacks[i].getElementsByClassName("coordinateY")[0].innerHTML.replace(/[^\d.-]/g, '');
